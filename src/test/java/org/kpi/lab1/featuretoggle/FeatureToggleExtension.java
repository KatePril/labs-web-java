        ...
        .ifPresent(
            method -> {
              ...
              if (method.isAnnotationPresent(EnabledFeatureToggle.class)) {
                ...
                featureToggleService.enableFeatureToggle(enabledFeatureToggle.value().getFeatureName());
                  ...
                  featureToggleService.disableFeatureToggle(disabledFeatureToggle.value().getFeatureName());
              }
            });
    }
